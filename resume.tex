...
% CONTACT INFORMATION
%====================
\def\name{Ankush Mehra} % Name Here
\def\phone{(+91) 8178986672}
\def\city{ (India) IN}
\def\email{ankushmehra.dev@gmail.com}
\def\LinkedIn{ankush-mehra-9a57a1233} % linkedin.com/in/______
\def\github{mehraankush} % github username
\def\role{Software Development Engineer} % JOB TITLE
\def\dsa{250+ GeekForGeeks , 200+ LeetCode}
